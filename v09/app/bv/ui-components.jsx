import { calculateBvAps, calculateClassicalRcv, calculateIndexOfIndividuality, calculateLognormalRcv, calculateSerialRelativeChange, evaluateClassicalRcvExceedance } from "./calc.js";
import { BV_MISSING_FIELDS_STAY_MISSING_NOTE } from "./data.js";
import { Badge } from "../ui/shared-components.jsx";
...
export function humanizeBvLabel(s) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const BV_II_BAND_ICONS = {
  "marked-individuality": "◆",
  "intermediate-individuality": "◈",
  "low-individuality": "◇",
  "not-computable": "—"
};
export const BV_RCV_EXCEEDANCE_ICONS = {
  "exceeds": "▲",
  "does-not-exceed": "●",
  "not-computable": "—"
};
export const BV_RI_STATUS_ICONS = {
  "inside-reference-interval": "○",
  "outside-reference-interval": "△",
  "not-stated": "—"
};
export const BV_TRANSPORTABILITY_ICONS = {
  "direct-match": "✓",
  "caution-needed": "!",
...
export function BvStatusBadge({ kind, value, labelOverride }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function ProvenanceCard({ estimate }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function HowCalculatedDisclosure({ result }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function IndexOfIndividualityDisplay({ cvi, cvg }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function BvApsTable({ cvi, cvg }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function ClassicalRcvDisplay({ cva, cvi, zConventionId }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function LognormalRcvDisplay({ cva, cvi, zConventionId }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function RiVsRcvComparisonPanel({ referenceInterval, previousResult, currentResult, cva, cvi, zConventionId }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const VARIATION_VISUAL_SET_POINTS = [-1.4, -0.7, -0.1, 0.4, 1.0, 1.6]; /* fixed, deterministic relative positions (SD units) */
export const VARIATION_VISUAL_REPLICATE_OFFSETS = [-0.6, 0.2, 0.7]; /* fixed, deterministic relative replicate offsets (SD units) */

export function VariationFoundationsVisual({ cva, cvi, cvg }) {
  const W = 720, H = 260;
