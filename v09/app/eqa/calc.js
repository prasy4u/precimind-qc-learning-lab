import { MILAN_MODELS, OTHER_SPEC_SOURCES } from "../strategy/core.js";
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const TARGET_VALUE_TYPES = [
...
export const TARGET_VALUE_TYPE_LABELS = {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const COMMUTABILITY_STATUSES = [
  "verified-commutable",
  "noncommutable",
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const CURRENT_EQA_STATUSES = ["meets-criterion", "does-not-meet-criterion", "criterion-not-stated", "indeterminate"];
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const LONGITUDINAL_EQA_STATUSES = [
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const EQA_INVESTIGATION_STATUSES = [
  "not-yet-reviewed",
  "under-review",
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const PERFORMANCE_CRITERION_TYPES = [
...
export const PERFORMANCE_CRITERION_TYPE_LABELS = {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function calculateEqaAbsoluteDeviation(participantResult, assignedValue) {
...
export function calculateEqaRelativeDeviation(participantResult, assignedValue) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function calculateEqaZScore(participantResult, assignedValue, sdpa) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const ILLUSTRATIVE_ZSCORE_BANDS = [
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function calculatePairedDifference(resultA, resultB) {
...
export function calculatePairedRelativeDifference(resultA, resultB) {
...
/* -------------------------------------------------------------------------
   ...
   rather than guessed.
   ------------------------------------------------------------------------- */
export function describeSchemeCapability(profile) {
  const p = profile || {};
  const statements = [];
  const limitations = [];
