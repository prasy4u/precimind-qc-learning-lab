...
import { PERFORMANCE_CRITERION_TYPE_LABELS, TARGET_VALUE_TYPE_LABELS, calculatePairedDifference, calculatePairedRelativeDifference, describeSchemeCapability } from "./calc.js";
import { CAPABILITY_MILLER_ATTRIBUTION_NOTE, COMPARABILITY_LIMIT_LABEL, DESIGNATED_COMPARATOR_NOTE, LONGITUDINAL_PATTERN_LABELS, MISSING_FIELDS_STAY_MISSING_NOTE, SCHEME_CAPABILITY_INPUTS } from "./data.js";
import { ExerciseRevealCard } from "../strategy/screens.jsx";
import { useState, useMemo, useRef, useEffect } from "react";
import { StatusBadge } from "../investigation/ui-components.jsx";
import { LJChart } from "../ui/shared-components.jsx";
...
export function humanizeEqaStatus(s) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const EQA_COMMUTABILITY_ICONS = {
  "verified-commutable": "✓",
  "noncommutable": "✕",
  "commutability-not-established": "?",
  "not-applicable-or-insufficient-information": "—"
};
export const EQA_CURRENT_STATUS_ICONS = {
  "meets-criterion": "✓",
  "does-not-meet-criterion": "△",
  "criterion-not-stated": "—",
  "indeterminate": "?"
};
export const EQA_LONGITUDINAL_ICONS = {
...
export const EQA_COMPARABILITY_ICONS = {
  "stable-agreement": "●",
  "step-change": "⤴",
  "gradual-divergence": "↝",
  "temporary-excursion": "◇",
...
export const EQA_INVESTIGATION_ICONS = {
  "not-yet-reviewed": "○",
  "under-review": "◐",
...
export function EqaStatusBadge({ kind, value }) {
...
export function EqaStatusRow({ currentEqaStatus, longitudinalEqaPattern, comparabilityStatus, investigationStatus }) {
  return (
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function EqaReportCard({ result }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function CommutabilityChallengeComponent({ example }) {
  const ex = example;
  return (
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function SchemeCapabilityProfileDisplay({ profile }) {
...
export function SchemeCapabilityProfileBuilder({ profile, onChange }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function LongitudinalEqaChart({ timeline, criterionLabel }) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export function PairedComparisonTable({ specimens, criterion }) {
...
export function LongitudinalComparabilityTable({ rows }) {
  return (
    <div className="table-scroll">
      <table className="data-table">
