import { CLASSIC_MODE_NOTE, DECISION_GUARDRAIL_NOTE, DETECTIVE_CASES, DIRECT_MODE_NOTE, FALSE_REJECTION_NOTE, INSPECTOR_DEFAULT_RUNS, RULE_DEFINITIONS, RULE_LAB_INTRO, RULE_OPTIONS_FOR_CHALLENGE, RUN_CONCEPT_NOTE, SCOPE_OPTIONS_FOR_CHALLENGE } from "./data.js";
import { RULE_LABELS, RULE_ORDER, evaluateRuleSet } from "./engine.js";
import { EventCard, MultiLevelLJChart, keyFor } from "./ui-components.jsx";
import { CONFIDENCE_OPTIONS, getConfidenceNote } from "../ui/app-data.js";
import { Badge, MetricCard, ScientificBasisNote } from "../ui/shared-components.jsx";
...
/* ---------------------------- LEARN THE RULES ---------------------------- */
export function LearnRulesPanel() {
...
export function InspectSequencePanel({ markProgress }) {
...
/* ---------------------------- RULE DETECTIVE ---------------------------- */
export const DEFAULT_DETECTIVE_ANSWER = { rules: [], points: null, scope: null, confidence: null, submitted: false };

export function RuleDetectivePanel({ level, markProgress }) {
...
/* ---------------------------- SCREEN SHELL ---------------------------- */
export function RuleLaboratoryScreen({ level, markProgress, goto }) {
