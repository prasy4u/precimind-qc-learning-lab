...
export const pilot3RcvPatientImpact = {
  ...
  panels: [
    ...
    { id: 'panel-specimen-context', type: 'PATIENT_RISK_CONTEXT', availableFromPhase: 'CHARACTERISATION', relevance: 'RELEVANT', costTimeMinutes: 2, mayBeMisleading: false, provenance: 'Specimen collection/handling log', content: { note: 'No documented preanalytical error (hemolysis, clotting, wrong tube, delayed processing) is noted for the repeat specimen. IMPORTANT LIMIT: absence of a DOCUMENTED issue does not exhaustively rule out an undocumented specimen-specific factor — this evidence is supportive, not decisive, on the preanalytical question.', learnerNote: 'No documented preanalytical error (hemolysis, clotting, wrong tube, delayed processing) is noted for the repeat specimen.' } },
