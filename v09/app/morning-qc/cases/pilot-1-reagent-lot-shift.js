...
export const pilot1ReagentLotShift = {
  ...
  decisionOpportunities: [
    { id: 'dec-containment', category: 'CONTAINMENT', availableFromPhase: 'IMMEDIATE_CONTAINMENT', options: [
      { id: 'opt-hold', label: 'Hold results pending investigation', consequenceSummary: 'Safe; appropriate given a sustained rule violation.', severity: 'INFORMATIONAL', outcomeAppropriate: true },
      { id: 'opt-continue', label: 'Continue analysis without holding', consequenceSummary: 'Unsafe given a sustained, uninvestigated shift.', severity: 'UNSAFE', outcomeAppropriate: false },
    ]},
    { id: 'dec-disposition', category: 'DISPOSITION', availableFromPhase: 'RESUME_OR_HOLD', options: [
      { id: 'opt-resume-verified', label: 'Resume after verified correction and patient-impact review', consequenceSummary: 'Correct disposition.', severity: 'INFORMATIONAL', outcomeAppropriate: true },
      { id: 'opt-resume-unverified', label: 'Resume immediately after switching lots, without re-verifying', consequenceSummary: 'Premature release risk.', severity: 'CRITICAL_UNSAFE', outcomeAppropriate: false },
    ]},
  ],
