...
import { ALERT_INTERPRETATION_STATEMENT, ALERT_ROUTES_TO_INVESTIGATION_NOTE, ALGORITHMS_EXCLUDED_FROM_V08, ALGORITHMS_IMPLEMENTED, ALGORITHMS_MENTIONED_NOT_IMPLEMENTED, ALGORITHM_SCOPE_NOTE, CASE_MIX_EXCLUSION_DANGER_NOTE, DISTRIBUTION_SIGNATURE_EXPERIMENT, METHODOLOGICAL_DEVELOPMENT_NOTE, NEVER_CALIBRATION_FAILURE_NOTE, NO_LIVE_DATA_NOTE, N_R_M_W_DISTINCTION_EXAMPLE, N_R_M_W_DISTINCTION_STATEMENT, PATIENT_POPULATIONS, PBRTQC_CHALLENGE_CASES, PBRTQC_COMPLEMENTARY_NOTE, PBRTQC_CONFIDENCE_NEVER_ALTERS_SCORE_NOTE, PBRTQC_CORE_PRINCIPLE, PBRTQC_EXCLUSION_LIST, PBRTQC_LEVEL_EXPLANATION, PBRTQC_NOT_DELTA_CHECK_STATEMENT, PBRTQC_NOT_EQA_STATEMENT, PBRTQC_NOT_JUST_MOVING_AVERAGE_NOTE, PBRTQC_PATHWAY_CAUTION, PBRTQC_PATHWAY_STEPS, PBRTQC_VS_CVG_DISTINCTION, PBRTQC_VS_RCV_DISTINCTION, POPULATION_SHIFT_WITHOUT_ERROR_SCENARIO, PROCESSING_ORDER_NOTE, PROCESSING_PIPELINE_STEPS, SLIDING_VS_BLOCKS_NOTE, STABLE_PBRTQC_DOES_NOT_VALIDATE_STATEMENT } from "./data.js";
import { ChangedVsConstantPanel, PatientStreamChart, humanizePbrtqcLabel } from "./ui-components.jsx";
...
import { SUPPORTED_ERROR_TYPES, calculateEWMA, calculateNPed, calculatePointwiseFalseFlagRate, calculateSlidingMean, calculateSlidingMedian } from "./calc.js";
import { AGGRESSIVE_TRUNCATION_EXPERIMENT, ALERT_BOUNDARY_NOTE, CONTROL_LIMIT_PROVENANCE_NOTE, ERROR_DETECTION_RECOMMENDED_FLOW, MEAN_VS_MEDIAN_ROBUSTNESS_NOTE, MEDIAN_NOT_UNIVERSALLY_BETTER_NOTE, MULTIPLE_ANALYZER_EXPERIMENT, PBRTQC_ANSWER_KIND_OPTIONS, STARTING_CONFIGURATION_LANGUAGE_NOTE, THROUGHPUT_ASSUMPTION_LABEL, THROUGHPUT_EXAMPLE, THROUGHPUT_NOTE, TRUNCATION_NOTE } from "./data.js";
import { EwmaSummary, MovingStatisticSummary, NPedSummaryCard, TrainingVerificationDisclosure } from "./ui-components.jsx";
...
/* ---------------------------- PBRTQC FOUNDATIONS ---------------------------- */
export function PbrtqcFoundationsPanel({ markProgress }) {
...
export function PatientDistributionLabPanel({ goto }) {
...
/* ---------------------------- ALGORITHM LAB ---------------------------- */
export function AlgorithmLabPanel() {
...
export function ErrorDetectionSimulatorPanel({ markProgress, goto }) {
...
/* ---------------------------- PBRTQC CHALLENGE ---------------------------- */
export function PbrtqcChallengePanel({ markProgress }) {
...
/* ---------------------------- SCREEN SHELL ---------------------------- */
export function PatientSurveillanceLabScreen({ level, markProgress, goto }) {
