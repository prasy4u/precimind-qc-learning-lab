...
export const PHASE_ALLOWS_RETURN_TO = {
  ...
  // Corrective-closure addition: a failed verification attempt (see
  // engine.js's VERIFY_RECOVERY handler) deterministically regresses to
  // INVESTIGATION, per this table entry, implementing the previously-
  // declared-but-unused return path.
  VERIFICATION: ['INTERVENTION', 'INVESTIGATION'],
