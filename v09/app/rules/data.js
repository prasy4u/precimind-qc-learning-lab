...
export const RULE_IDS = ["12s", "13s", "22s", "r4s", "41s", "10x"];

export function rcr(levelId, levelName, z) {
  return { levelId, levelName, rawValue: roundTo(100 + z * 2, 2), zScore: z };
}
export function rrun(n, l1, l2, event) {
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const INSPECTOR_DEFAULT_RUNS = [
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
export const RULE_OPTIONS_FOR_CHALLENGE = [
...
export const SCOPE_OPTIONS_FOR_CHALLENGE = [
