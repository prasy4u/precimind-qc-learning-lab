import { operatingCharacteristic13s } from "../opchar/functions.js";
import { ANALYTICAL_RUN_V4_DEFINITION, ANPED_NOTE, BRACKETED_QC_NOTE, CHANGE_PED_HOLD_M_EXPERIMENT, CLINICAL_CONSEQUENCE_NOTE, CORE_DISTINCTION_CAUTIONS, FAILURE_ONSET_MODES, FREQUENCY_CHALLENGE_CASES, FREQUENCY_DESIGNER_DEFAULTS, FREQUENCY_EXPOSURE_LAB, HIGH_SIGMA_FREQUENCY_MISCONCEPTION_NOTE, LIKELY_EFFECT_OPTIONS, MAXE_GOAL_NOTE, MAXE_NUF_BOUNDARY_NOTE, MAXE_NUF_DEFINITION, MAXE_NUF_NOT_ONLY_FRAMEWORK_NOTE, MORE_QC_NOT_ALWAYS_BETTER_NOTE, M_OPTIONS, NOMOGRAM_CONCEPT_NOTE, N_R_M_DISTINCTION_NOTE, OUT_OF_CONTROL_EVENT_PREVIEW, PARVIN_SECTION_INTRO, PATIENT_RISK_SIGMA_CAUTION, PATIENT_SAMPLES_EXPOSED_DEFINITION, PROCESS_STABILITY_NOTE, QC_EVENT_DEFINITION, QC_FREQUENCY_DEFINITION, QC_PROCEDURE_DEFINITION, RISK_MODEL_LIMITATION_NOTE, SHIFT_OPTIONS_SD, STARTUP_VS_MONITORING_NOTE, UNACCEPTABLE_RESULTS_DEFINITION, WHAT_CHANGED_OPTIONS, WHICH_COMPONENT_CHANGED_EXPERIMENT, WORKED_NOMOGRAM_EXAMPLE } from "./data.js";
import { detectionDelaySupportForRuleIds, expectedPatientExposureImmediateOnset, expectedPatientExposureUniformOnset, expectedQcEventsToDetectionGeometric } from "./detection-delay.js";
import { DetectionDelayResultCard, NRMPanel, QCTimeline, QuadrantMatrix } from "./ui-components.jsx";
...
/* ---------------------------- FREQUENCY SIMULATOR ---------------------------- */
export function FrequencySimulatorPanel({ markProgress }) {
...
/* ---------------------------- DETECTION DELAY ---------------------------- */
export function DetectionDelayPanel({ markProgress }) {
  const [n, setN] = useState(2);
...
export function FrequencyDesignerPanel({ markProgress }) {
...
export function SameFrequencyDifferentProcedurePanel() {
...
export function PatientRiskExplorerPanel({ markProgress }) {
  return (
    <div>
...
/* ---------------------------- FREQUENCY CHALLENGE ---------------------------- */
export const DEFAULT_RISK_ANSWER = { whatChanged: null, likelyEffect: null, revealedNext: false, confidence: null, submitted: false };

export function FrequencyChallengePanel({ markProgress }) {
...
/* ---------------------------- SCREEN SHELL ---------------------------- */
export function RiskFrequencyLabScreen({ level, markProgress, goto }) {
